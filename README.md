...
- mkdir -m 777 /PYTHON
- apt install git
- git clone https://github.com/256cub/HEC.git
- cd /PYTHON/HEC
- python install.py

### Add Startup Application GUI
- xterm -geometry 250x25+50+0 -hold -e python -i /PYTHON/HEC/HEC.py
- xterm -geometry 250x25+50+500 -hold -e python -i /PYTHON/HEC/HEC.py
